...
struct spark_timer
{
  time_t start;         /* Start time. Reload whenever the timer expires */
  time_t interval;      /* Timer interval to be expressed in milliseconds */
  time_t msec;          /* Elapsed milliseconds */
};
